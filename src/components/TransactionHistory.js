        ...
        <>
            <div className="transac-history-box">
                ...
                <div className="filter-container">
                    <Button className='btns' buttonStyle='rectangle' buttonSize='small'>Amount</Button>
                    <Button className='btns' buttonStyle='rectangle' buttonSize='small'>Category</Button>
                    <Button className='btns' buttonStyle='rectangle' buttonSize='small'>Etc...</Button>
